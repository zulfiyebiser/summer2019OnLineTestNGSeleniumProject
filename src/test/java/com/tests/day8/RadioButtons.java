...
//        this is step is common for all test cases
    ...
    public void test1(){
        ...
        Assert.assertTrue(isSelected);// wil expected that isSelected is true
    }
    @Test(description = "Verify that red button is not selected")
    public void test2(){
        WebElement redButton = driver.findElement(By.id("red"));
        Assert.assertFalse(redButton.isSelected());// wil expected that isSelected is false
    }
